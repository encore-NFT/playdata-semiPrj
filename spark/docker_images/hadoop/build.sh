...
# # hadoop-datanode
# docker build --platform linux/amd64 --no-cache -t hadoop-datanode:hadoop3.2.2-java8 ./datanode
...
# # # hadoop-resourcemanager
# docker build --platform linux/amd64 --no-cache -t hadoop-resourcemanager:hadoop3.2.2-java8 ./resourcemanager